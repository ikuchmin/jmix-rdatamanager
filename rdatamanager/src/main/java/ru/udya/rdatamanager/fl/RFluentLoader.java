...
@Component("rdm_RFluentLoader")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RFluentLoader<E> {

    private Class<E> entityClass;
    private MetaClass metaClass;

    private UnconstrainedRDataManager dataManager;
    ...
    public RFluentLoader(Class<E> entityClass) {
    ...
    public static class ById<E> {
        ...
        private RFluentLoader<E> loader;
        private Object id;

        protected ById(RFluentLoader<E> loader, Object id) {
            this.loader = loader;
            this.id = id;
        }
         ...
         */
        public Mono<E> optional() {
            if (id != null) {
                LoadContext<E> loadContext = createLoadContext();
                return loader.dataManager.load(loadContext);
            } else {
                return Mono.empty();
            }
        }
        ...
        public Mono<E> one() {
            ...
            return Mono.error(new IllegalStateException("No results"));
        }
    ...
    public static class ByIds<E> {
        ...
        protected ByIds(RFluentLoader<E> loader, Collection ids) {
            this.loader = loader;
            this.ids = ids;
        }
        ...
        /**
         * Sets a fetch plan configured by the {@link io.jmix.core.FetchPlanBuilder}. For example:
         * <pre>
         *     dataManager.load(Pet.class)
         *         .ids(id1, id2)
    ...
    public static class ByQuery<E> {
        ...
        protected ByQuery(RFluentLoader<E> loader, String queryString, ApplicationContext applicationContext) {
            Preconditions.checkNotEmptyString(queryString, "queryString is empty");
            this.loader = loader;
            this.queryString = queryString;
        }

        protected ByQuery(RFluentLoader<E> loader, String queryString, Object[] positionalParams, ApplicationContext applicationContext) {
        ...
        public Mono<E> one() {
            LoadContext<E> loadContext = createLoadContext();
            return loader.dataManager.load(loadContext).switchIfEmpty(
    ...
    public static class ByCondition<E> {
        ...
        protected ByCondition(RFluentLoader<E> loader, String entityName, Condition condition) {
            this.loader = loader;
